		...
		var _v = {
			...
			_f = {
				init: function() {
					...
					$('#addRealName').css('display', 'block').click(function() {
						location.href = 'http://' + location.host + '/publicorder_wap/page/realname_waste_add.html';
					});
					_f.initPage('');
				},
			...
			_t = {
				...
				searchResultsList: function(data) {
					...
					html = $(html);
					html.click(function() {
						location.href = 'http://' + location.host + '/publicorder_wap/page/realname_waste_details.html?id=' + data.ds_shimingzhiid;
					});
					return html;
				},
			},
