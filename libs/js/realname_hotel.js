		...
		var _v = {
			...
			_f = {
				init: function() {
					...
					$('#addRealName').css('display', 'block').click(function() {
						location.href = 'http://' + location.host + '/publicorder_wap/page/realname_hotel_add.html';
					});
					_f.initPage('');
				},
			...
			_t = {
				...
				searchResultsList: function(data) {
					...
					html += '		<span>房&nbsp;&nbsp;间&nbsp;&nbsp;号 : </span><span class="com-color">' + data.ds_roomnum + '</span><br>';
					html += '		<span>入住时间 : </span><span class="com-color">' + data.intoDate + '</span><br>';
					html += '		<span>入住天数 : </span><span class="com-color">' + data.ds_stayday + ' 天' + '</span>';
					html += '	</div>';
					html += '	<div class="icon"></div>';
					html += '</div>';
					html = $(html);
					html.click(function() {
						location.href = 'http://' + location.host + '/publicorder_wap/page/realname_hotel_details.html?id=' + data.ds_shimingzhiid;
					});
					return html;
				},
			},
